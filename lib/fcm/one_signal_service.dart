...
class OneSignalService {
  Future _navigateToRequiredScreen(OSNotification payload,
    ...
    // log("CLEANED PAYLOAD ==> ${payload.rawPayload!['custom']}");
    // log("CLEANED PAYLOAD JSON ==> ${jsonDecode(payload.rawPayload!['custom'])["a"]}");
    // return;

    // popUpAlert(title: "Received", message: payload.jsonRepresentation());
