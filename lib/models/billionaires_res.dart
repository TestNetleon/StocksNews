...
class BillionairesRes {
  ...
  final RecentMentions? topBillionaires;
  ...
  factory BillionairesRes.fromMap(Map<String, dynamic> json) => BillionairesRes(
    ...
    tabs: json["tabs"] == null ? [] : List<MarketResData>.from(json["tabs"]!.map((x) => MarketResData.fromJson(x))),
    ...
    topBillionaires: json["top-billionaires"] == null ? null : RecentMentions.fromMap(json["top-billionaires"]),
  ...
  Map<String, dynamic> toMap() => {
    ...
    "top-billionaires": topBillionaires?.toMap(),
...
class SymbolMentionList {
  final String? title;
  final String? subTitle;
  final List<SymbolMentionListDatum>? data;
  ...
  factory SymbolMentionList.fromMap(Map<String, dynamic> json) => SymbolMentionList(
    title: json["title"],
    subTitle: json["sub_title"],
    data: json["data"] == null ? [] : List<SymbolMentionListDatum>.from(json["data"]!.map((x) => SymbolMentionListDatum.fromMap(x))),
  );
...
class SymbolMentionListDatum {
  ...
  factory SymbolMentionListDatum.fromMap(Map<String, dynamic> json) => SymbolMentionListDatum(
    symbol: json["symbol"],
    count: json["count"],
    name: json["name"],
