...
BillionairesRes billionairesResFromJson(String str) =>
    BillionairesRes.fromMap(json.decode(str));
...
class BillionairesRes {
  ...
  factory BillionairesRes.fromMap(Map<String, dynamic> json) => BillionairesRes(
        ...
        recentMentions: json["recent_mentions"] == null
            ? null
            : RecentMentions.fromMap(json["recent_mentions"]),
        symbolMentionList: json["symbol_mentions"] == null
            ? null
            : SymbolMentionList.fromMap(json["symbol_mentions"]),
      );
...
class CryptoTweetPost {
  ...
  factory CryptoTweetPost.fromMap(Map<String, dynamic> json) => CryptoTweetPost(
        ...
        symbols: json["symbols"] == null
            ? []
            : List<Symbols>.from(
                json["symbols"]!.map((x) => Symbols.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "symbols": symbols == null
            ? []
            : List<dynamic>.from(symbols!.map((x) => x.toMap())),
      };
}

RecentMentions viewBillsResFromJson(String str) =>
    RecentMentions.fromMap(json.decode(str));
...
class RecentMentions {
  ...
  factory RecentMentions.fromMap(Map<String, dynamic> json) => RecentMentions(
        ...
        data: json["data"] == null
            ? []
            : List<CryptoTweetPost>.from(
                json["data"]!.map((x) => CryptoTweetPost.fromMap(x))),
      );
...
class SymbolMentionList {
  ...
  factory SymbolMentionList.fromMap(Map<String, dynamic> json) =>
      SymbolMentionList(
        title: json["title"],
        subTitle: json["sub_title"],
        data: json["data"] == null
...
class TopTab {
  ...
  factory TopTab.fromMap(Map<String, dynamic> json) => TopTab(
        ...
        billionaires: json["billionaires"] == null
            ? null
            : RecentMentions.fromMap(json["billionaires"]),
