...
class WatchRes {
  ...
  factory WatchRes.fromMap(Map<String, dynamic> json) => WatchRes(
        ...
        noData:
            json["no_data"] == null ? null : NoDataRes.fromMap(json["no_data"]),
        watches: json["data"] == null
            ? []
            : List<BaseTickerRes>.from(
                json["data"]!.map((x) => BaseTickerRes.fromJson(x))),
        deleteBox: json["delete_box"] == null
            ? null
            : DeleteBoxRes.fromMap(json["delete_box"]),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "data": watches == null
            ? []
            : List<dynamic>.from(watches!.map((x) => x.toJson())),
