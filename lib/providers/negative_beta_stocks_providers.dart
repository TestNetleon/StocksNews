...
class NegativeBetaStocksProvider extends ChangeNotifier with AuthProviderBase {
  ...
  Future getNegativeBetaStocks({loadMore = false, type = 1}) async {
    if (loadMore) {
      _page++;
