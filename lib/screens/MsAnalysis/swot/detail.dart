...
class MsSwotAnalysisDetail extends StatelessWidget {
  const MsSwotAnalysisDetail({super.key});
                  ...
                  child: Column(
                    children: [
                      Visibility(
                        ...
                        child: MsSwotAnalysisDetailItem(
                          title: 'Strength',
                          list: strengths,
...
class MsSwotAnalysisDetailItem extends StatelessWidget {
  final String title;
  final List<String>? list;
  final Color? color;
  const MsSwotAnalysisDetailItem(
