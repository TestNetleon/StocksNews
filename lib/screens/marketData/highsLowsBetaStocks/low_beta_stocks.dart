...
class _LowsBetaStocksState extends State<LowsBetaStocks> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      // AmplitudeService.logUserInteractionEvent(type: "Low Beta Stocks");
                ...
                child: BaseUiContainer(
                  ...
                  child: SlidableAutoCloseBehavior(
                    child: RefreshControl(
                      onRefresh: () async =>
                          provider.getLowsBetaStocks(type: 1),
  ...
  void _onAlertClick(
    ...
    if ((isAlertAdded?.toInt() ?? 0) == 1) {
      ...
      try {
        ApiResponse res =
            await context.read<LowsBetaStocksProvider>().getLowsBetaStocks();
        if (res.status) {
