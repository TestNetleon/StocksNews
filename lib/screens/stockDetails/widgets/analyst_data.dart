              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      // log("&&&&&&&&&&&&&&");
                      morningStarInfoSheet(data: morningStar?.description);
                    },
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: morningStar?.quantValuation == "Undervalued"
                        ? [
                            const Color.fromARGB(255, 242, 150, 37),
                            const Color.fromARGB(255, 144, 87, 17),
                          ]
                        : morningStar?.quantValuation == "Fairly Valued"
                            ? [
                                const Color.fromARGB(255, 14, 173, 5),
                                const Color.fromARGB(255, 11, 95, 13),
                              ]
                            // Overvalued
                            : [
                                Colors.red,
                                const Color.fromARGB(255, 140, 47, 40),
                              ],
                  ),
                ),
                child: Center(
                  child: Text(
                    "${morningStar?.quantValuation}".toUpperCase(),
                    style: stylePTSansBold(),
                    textAlign: TextAlign.center,
                  ),
                ),
                                ...
                                RadialAxis(
                                  ...
                                  ranges: <GaugeRange>[
                                    ...
                                    GaugeRange(
                                      ...
                                      endValue: maxValue,
                                      color:
                                          const Color.fromARGB(255, 23, 196, 0),
                                      label: 'Extreme',
                                      sizeUnit: GaugeSizeUnit.factor,
                                      labelStyle: const GaugeTextStyle(
                                        fontFamily: Fonts.ptSans,
                                  ...
                                  pointers: [
                                    NeedlePointer(
                                      value: radialValue,
                                      needleColor: ThemeColors.accent,
