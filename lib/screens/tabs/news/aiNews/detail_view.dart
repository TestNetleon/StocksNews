                  ...
                  children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            provider.detail?.postDetail?.authors?.isNotEmpty ==
                                        true ||
                                    provider.detail?.postDetail?.categories
                                            ?.isNotEmpty ==
                                        true
                                ? Padding(
                            ...
                            Visibility(
                              visible: provider
                                      .detail?.postDetail?.tags?.isNotEmpty ==
                                  true,
                              child: Padding(
                            ...
                            Visibility(
                              visible: provider.detail?.postDetail?.authors
                                          ?.isNotEmpty ==
                                      true &&
                                  provider.detail?.postDetail?.authors != null,
                              child: ListView.separated(
                                itemCount: provider
                                        .detail?.postDetail?.authors?.length ??
                                    0,
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                itemBuilder: (context, index) {
                                  DetailListType? data = provider
                                      .detail?.postDetail?.authors?[index];
                                  if (data?.show == false) {
                    ...
                    Positioned(
                      ...
                      child: ThemeButtonSmall(
                        onPressed: () {
                          commonShare(
                            title: provider.detail?.postDetail?.title ?? "",
