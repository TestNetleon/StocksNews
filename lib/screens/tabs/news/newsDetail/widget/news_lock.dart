...
//     bool showSubscribe = isLogin && !hasMembership && showMembership
...
//     Utils().showLog(
//         "Locked => ${showViewReport && provider.data?.postDetail?.readingStatus == false}");

//     if ((isLocked || provider.data?.postDetail?.readingStatus == false) &&
//         !provider.isLoading) {
//       return Column(
