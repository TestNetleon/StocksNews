...
class FiftyTwoWeeksHigh extends StatefulWidget {
  const FiftyTwoWeeksHigh({super.key});

  @override
  State<FiftyTwoWeeksHigh> createState() => _FiftyTwoWeeksHighState();
}

class _FiftyTwoWeeksHighState extends State<FiftyTwoWeeksHigh> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    FiftyTwoWeeksHighManager manager = context.read<FiftyTwoWeeksHighManager>();
