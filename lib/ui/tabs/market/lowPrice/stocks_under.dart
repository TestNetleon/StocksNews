...
class StocksUnder extends StatefulWidget {
  const StocksUnder({
    required this.slug,
    super.key,
  });
  ...
  @override
  State<StocksUnder> createState() => _StocksUnderState();
}

class _StocksUnderState extends State<StocksUnder> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    StocksUnderManager manager = context.read<StocksUnderManager>();
    await manager.getData(slug: widget.slug, loadMore: loadMore);
  }
