...
class MostVolatile extends StatefulWidget {
  const MostVolatile({super.key});

  @override
  State<MostVolatile> createState() => _MostVolatileState();
}

class _MostVolatileState extends State<MostVolatile> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    MostVolatileManager manager = context.read<MostVolatileManager>();
    await manager.getData(loadMore: loadMore);
  }

  @override
  Widget build(BuildContext context) {
    MostVolatileManager manager = context.watch<MostVolatileManager>();
