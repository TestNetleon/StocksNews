...
class UnusualTrading extends StatefulWidget {
  const UnusualTrading({super.key});

  @override
  State<UnusualTrading> createState() => _UnusualTradingState();
}

class _UnusualTradingState extends State<UnusualTrading> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    UnusualTradingManager manager = context.read<UnusualTradingManager>();
    await manager.getData(loadMore: loadMore);
  }

  @override
  Widget build(BuildContext context) {
    UnusualTradingManager manager = context.watch<UnusualTradingManager>();
