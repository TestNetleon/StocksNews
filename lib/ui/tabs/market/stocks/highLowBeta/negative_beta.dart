...
class NegativeBeta extends StatefulWidget {
  const NegativeBeta({super.key});

  @override
  State<NegativeBeta> createState() => _NegativeBetaState();
}

class _NegativeBetaState extends State<NegativeBeta> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    NegativeBetaManager manager = context.read<NegativeBetaManager>();
    await manager.getData(loadMore: loadMore);
  }

  @override
  Widget build(BuildContext context) {
    NegativeBetaManager manager = context.watch<NegativeBetaManager>();
