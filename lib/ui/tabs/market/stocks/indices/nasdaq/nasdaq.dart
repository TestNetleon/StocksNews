...
class Nasdaq extends StatefulWidget {
  const Nasdaq({super.key});

  @override
  State<Nasdaq> createState() => _NasdaqState();
}

class _NasdaqState extends State<Nasdaq> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    NasdaqManager manager = context.read<NasdaqManager>();
    await manager.getData(loadMore: loadMore);
  }

  @override
  Widget build(BuildContext context) {
    NasdaqManager manager = context.watch<NasdaqManager>();
