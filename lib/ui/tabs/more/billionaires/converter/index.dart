  ...
  Widget build(BuildContext context) {
    ...
    return BaseLoaderContainer(
      ...
      child: BaseScroll(
        ...
        children: [
          Visibility(
            visible: cryptoRates?.title != null && cryptoRates?.title != '',
            child: BaseHeading(
          ...
          Row(
            ...
            children: [
              IconButton(
                icon: Icon(Icons.swap_horizontal_circle_rounded, size: 24),
                onPressed: () {
                  manager.swapUI();
                },
              ),
              Text(
                ...
                style: styleBaseBold(fontSize: 14, fontFamily: "Roboto"),
              )
            ],
          ),
          ...
          Visibility(
              visible:
                  exchangeRates?.title != null && exchangeRates?.title != '',
              child: BaseHeading(
                margin: const EdgeInsets.symmetric(horizontal: 16.0),
