...
class CryptoTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Visibility(
            visible: symbolMentionRes?.title != null &&
                symbolMentionRes?.title != '',
            child: BaseHeading(
                              ...
                              DataCell(GestureDetector(
                                ...
                                child: Container(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: Pad.pad5, vertical: Pad.pad5),
                                  child: Row(
                                    crossAxisAlignment:
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        horizontalMargin: 10,
                        columns:
                            ["Price", "Pair", "Total Volume"].map((header) {
                          return DataColumn(
                            label: Text(
                              header,
                              style: styleBaseBold(
  ...
  DataCell _dataCellMentions(
      {required num text, required num count, bool userPercent = true}) {
    return DataCell(
      Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        ...
        children: [
          Text(
            ...
            style: styleBaseBold(
                fontSize: 12,
                color:
                    text >= 0 ? ThemeColors.success120 : ThemeColors.error120),
          ),
          Text(
            "$count (Mentions)",
            style: styleBaseBold(fontSize: 12, color: ThemeColors.neutral8),
          ),
        ],
      ),
    );
