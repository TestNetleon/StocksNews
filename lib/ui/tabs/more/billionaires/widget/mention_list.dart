                                      ...
                                      child: IconButton(
                                          ...
                                          onPressed: () {
                                            if(cryptos?.isCryptoAdded==0){
                                              manager.requestAddToWatch(cryptos?.symbol??"",cryptos: cryptos);
                                            }
                                            else{
                                              manager.requestRemoveToWatch(cryptos?.symbol??"",cryptos: cryptos);
                                            }
                                          },
                                          icon: cryptos?.isCryptoAdded==0?Icon(Icons.star_outline_sharp):
                                          Icon(Icons.star_sharp,color: ThemeColors.accent),
                                          iconSize: 26,
