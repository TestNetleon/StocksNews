...
class JoinReferVerificationIndex extends StatefulWidget {
  static const path = 'JoinReferVerificationIndex';
  final String name, displayName, phone, countryCode, verificationId;
  final bool? update;

  const JoinReferVerificationIndex({
    required this.name,
  ...
  @override
  State<JoinReferVerificationIndex> createState() =>
      _JoinReferVerificationIndexState();
}

class _JoinReferVerificationIndexState extends State<JoinReferVerificationIndex>
    with CodeAutoFill {
