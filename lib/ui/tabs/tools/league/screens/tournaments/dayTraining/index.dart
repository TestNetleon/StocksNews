...
import 'package:stocks_news_new/ui/tabs/tools/league/screens/tournaments/dayTraining/widgets/leaderboard.dart';
import 'package:stocks_news_new/ui/tabs/tools/league/screens/tournaments/dayTraining/widgets/rules.dart';
import 'package:stocks_news_new/ui/tabs/tools/league/screens/tournaments/dayTraining/widgets/timer.dart';
...
class LeagueDayTrainingIndex extends StatefulWidget {
  final int? tournamentId;
  static const path = 'LeagueDayTrainingIndex';
  const LeagueDayTrainingIndex({super.key, this.tournamentId});

  @override
  State<LeagueDayTrainingIndex> createState() =>
      _LeagueDayTrainingIndexState();
}

class _LeagueDayTrainingIndexState
    extends State<LeagueDayTrainingIndex> {
  @override
  void initState() {
    super.initState();
        ...
        child: BaseScroll(
          ...
          children: [
            ...
            CommonCard(
              ...
              padding: EdgeInsets.symmetric(vertical: Pad.pad10, horizontal: 0),
              child: ListTile(
                leading:
                Icon(
