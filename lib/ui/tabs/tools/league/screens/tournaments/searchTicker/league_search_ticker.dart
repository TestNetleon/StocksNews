...
import 'package:stocks_news_new/ui/tabs/tools/league/screens/tournaments/searchTicker/item.dart';
import 'package:stocks_news_new/utils/colors.dart';
import 'package:stocks_news_new/utils/constants.dart';
import 'package:stocks_news_new/utils/theme.dart';

class LeagueSearchTicker extends StatelessWidget {
  final SearchSymbolRes? symbolRes;
  final bool fromSearch;
  final Future<void> Function()? onRefresh;
  final void Function(BaseTickerRes)? stockClick;

  const LeagueSearchTicker({
    super.key,
    this.symbolRes,
    this.onRefresh,
    this.stockClick,
