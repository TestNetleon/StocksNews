...
class BaseSearchTicker extends StatefulWidget {
  final Function(String) onSearchChanged;

  const BaseSearchTicker({super.key, required this.onSearchChanged});

  @override
  State<BaseSearchTicker> createState() => _BaseSearchTickerState();
}

class _BaseSearchTickerState extends State<BaseSearchTicker> {
  ...
  Widget build(BuildContext context) {
    LeagueSearchManager manager = context.watch<LeagueSearchManager>();
    return Container(
