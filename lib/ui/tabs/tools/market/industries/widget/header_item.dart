        ...
        child: Column(
          ...
          children: [
            Text(
              header?.title ?? "",
              style:
                  styleBaseRegular(fontSize: 16, color: ThemeColors.splashBG),
            ),
            ...
            Text(
              ...
              style: styleBaseBold(
                fontSize: 28,
                color: header?.totalMentions?.colour == 1
                    ? ThemeColors.success
            ...
            Visibility(
              visible: header?.mentions != null ||
                  header?.mentions?.isNotEmpty == true,
                ...
                child: Row(
                  ...
                  children: List.generate(
                    ...
                    (index) {
                      ...
                      return Padding(
                        padding:
                            const EdgeInsets.symmetric(horizontal: Pad.pad8),
                        child: Row(
                          children: [
                            Container(
