...
class GapDown extends StatefulWidget {
  const GapDown({super.key});

  @override
  State<GapDown> createState() => _GapDownState();
}

class _GapDownState extends State<GapDown> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    GapDownManager manager = context.read<GapDownManager>();
    await manager.getData(loadMore: loadMore);
  }

  @override
  Widget build(BuildContext context) {
    GapDownManager manager = context.watch<GapDownManager>();
