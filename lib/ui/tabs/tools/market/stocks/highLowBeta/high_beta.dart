...
class HighBeta extends StatefulWidget {
  const HighBeta({super.key});

  @override
  State<HighBeta> createState() => _HighBetaState();
}

class _HighBetaState extends State<HighBeta> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    HighBetaManager manager = context.read<HighBetaManager>();
    await manager.getData(loadMore: loadMore);
  }

  @override
  Widget build(BuildContext context) {
    HighBetaManager manager = context.watch<HighBetaManager>();
