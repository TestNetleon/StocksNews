...
class Snp500 extends StatefulWidget {
  const Snp500({super.key});

  @override
  State<Snp500> createState() => _Snp500State();
}

class _Snp500State extends State<Snp500> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    Snp500Manager manager = context.read<Snp500Manager>();
