...
class MostActive extends StatefulWidget {
  const MostActive({super.key});

  @override
  State<MostActive> createState() => _MostActiveState();
}

class _MostActiveState extends State<MostActive> {
  @override
  void initState() {
    super.initState();
  ...
  Future _callAPI({loadMore = false}) async {
    MostActiveManager manager = context.read<MostActiveManager>();
    await manager.getData(loadMore: loadMore);
  }

  @override
  Widget build(BuildContext context) {
    MostActiveManager manager = context.watch<MostActiveManager>();
