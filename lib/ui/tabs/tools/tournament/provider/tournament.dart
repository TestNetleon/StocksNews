...
import 'package:stocks_news_new/ui/tabs/tools/tournament/screens/tournaments/tournament_user/tournament_user_detail.dart';
import 'package:stocks_news_new/ui/tabs/tools/tournament/screens/tournaments/tournament_user/trades_with_date.dart';
...
// MARK: JOIN
  Future joinTounament({int? id}) async {
    UserManager uPrivder = navigatorKey.currentContext!.read<UserManager>();
    if (uPrivder.user == null) {
      await uPrivder.askLoginScreen();
          ...
          if (symbols != null && symbols.isNotEmpty == true) {
            ...
            SSEManager.instance.addListener(
              ...
              (stockData) {
                ...
                Utils().showLog(
                    'Recent Activities ${data.symbol}, ${data.performance}, ${data.gainLoss}, ${data.currentPrice}');
                notifyListeners();
              },
          ...
          if (symbols != null && symbols.isNotEmpty == true) {
            ...
            SSEManager.instance.addListener(
              ...
              (stockData) {
                ...
                Utils().showLog(
                    'Recent Activities of All trade ${data.symbol}, ${data.performance}, ${data.gainLoss}, ${data.currentPrice}');
                notifyListeners();
              },
